...
router.post('/', (0, auth_1.authorize)('admin', 'teacher'), (0, validation_1.validateBody)(attendance_1.CreateAttendanceSchema), attendanceController_1.markAttendance);
router.post('/bulk', (0, auth_1.authorize)('admin', 'teacher'), (0, validation_1.validateBody)(attendance_1.CreateBulkAttendanceSchema), attendanceController_1.markBulkAttendance);
router.get('/', (0, validation_1.validateQuery)(attendance_1.AttendanceQuerySchema), attendanceController_1.getAttendanceRecords);
