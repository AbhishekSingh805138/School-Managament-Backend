...
router.post('/', (0, auth_1.authorize)('admin'), rateLimiting_1.adminRateLimit, sanitization_1.sanitizeAcademicYear, (0, validation_1.validateBody)(academic_1.CreateAcademicYearSchema), academicYearController_1.createAcademicYear);
...
router.put('/:id', (0, auth_1.authorize)('admin'), (0, validation_1.validateParams)(zod_1.z.object({ id: common_1.IdSchema })), sanitization_1.sanitizeAcademicYear, (0, validation_1.validateBody)(academic_1.UpdateAcademicYearSchema), academicYearController_1.updateAcademicYear);
