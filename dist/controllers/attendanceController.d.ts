...
export declare const getAttendance: (req: Request, res: Response, next: import("express").NextFunction) => void;
export declare const getAttendanceById: (req: Request, res: Response, next: import("express").NextFunction) => void;
export declare const updateAttendance: (req: Request, res: Response, next: import("express").NextFunction) => void;
