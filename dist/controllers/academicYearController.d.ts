...
export declare const createAcademicYear: (req: Request, res: Response, next: import("express").NextFunction) => void;
export declare const getAcademicYears: (req: Request, res: Response, next: import("express").NextFunction) => void;
export declare const getAcademicYearById: (req: Request, res: Response, next: import("express").NextFunction) => void;
