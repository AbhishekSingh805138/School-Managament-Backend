...
export declare const createGrade: (req: Request, res: Response, next: import("express").NextFunction) => void;
export declare const getGrades: (req: Request, res: Response, next: import("express").NextFunction) => void;
